import { MochiFeedComponent, MochiComposerComponent } from './MochiApp'
...
export default class BlockFactory {
  static getFeedComponent(model: BlockModel) {
    switch (model.type) {
      ...
      case "Mochi": return <MochiFeedComponent model={model} />;
  ...
  static getComposerComponent(props: ComposerComponentProps) {
    ...
    switch (model.type) {
      ...
      case "Mochi": return MochiComposerComponent(props);
